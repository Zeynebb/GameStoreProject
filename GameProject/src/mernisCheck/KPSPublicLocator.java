...
public class KPSPublicLocator extends org.apache.axis.client.Service implements mernisCheck.KPSPublic {
    ...
    public mernisCheck.KPSPublicSoap getKPSPublicSoap() throws javax.xml.rpc.ServiceException {
    ...
    public mernisCheck.KPSPublicSoap getKPSPublicSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            mernisCheck.KPSPublicSoapStub _stub = new mernisCheck.KPSPublicSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (mernisCheck.KPSPublicSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                mernisCheck.KPSPublicSoapStub _stub = new mernisCheck.KPSPublicSoapStub(new java.net.URL(KPSPublicSoap_address), this);
                _stub.setPortName(getKPSPublicSoapWSDDServiceName());
                return _stub;
            }
        }
